...
async def help_cmd(client: Client, message: Message):
    ...
    try:
        await message.reply_photo(photo=Config.HELP_PHOTO, caption=text, reply_markup=buttons)
    except Exception:
...
async def about_cmd(client: Client, message: Message):
    ...
    try:
        await message.reply_photo(photo=Config.ABOUT_PHOTO, caption=text, reply_markup=buttons)
    except Exception:
        await message.reply_text(text, reply_markup=buttons)
